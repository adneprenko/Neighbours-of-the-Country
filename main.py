...
def process_country(country):
    # Code to process choosen country
...
def delete_country():
    # Getting index of country
    selected_index = listbox.curselection()
    if selected_index:
        index = selected_index[0]
        # Deleting choosen country from Listbox
...
class CountrySelectionFrame(tk.Frame):
    def __init__(self, master, countries):
        ...
        # Creating scroll to countries list
        ...
        # Connection of scroll to listbox
